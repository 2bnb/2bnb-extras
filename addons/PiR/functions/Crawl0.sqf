...
params ["_unit", "_anim", "_shans", "_shooter", "_unitGrp", "_unitGrpPR", "_pWeapon", "_sWeapon", "_hWeapon", "_magsremoveB", "_unitStance", "_dis", "_Pos", "_timer", "_pWItems", "_sWItems", "_hWItems", "_pmag", "_smag", "_hmag", "_binocs", "_udalenie", "_unitLdr", "_magsremoveV", "_magsremoveB"];    
...
//__________________________________________________________Выход_______________________________________________________________			 
				...
				[{!((_this select 0) getVariable ["dam_player_Crawl0",false]) or (!alive (_this select 0))
				 ...
				 _unit setVariable ["dam_player_Crawl0",false,true];
					...
					}, [_unit, _anim, _shans, _shooter, _unitGrp, _unitGrpPR, _pWeapon, _sWeapon, _hWeapon, _magsremoveB, _unitStance, _dis, _Pos, _timer, _pWItems, _sWItems, _hWItems, _pmag, _smag, _hmag, _binocs, _udalenie, _unitLdr, _magsremoveV, _magsremoveB], 2] call CBA_fnc_waitAndExecute;	
				}, [_unit, _anim, _shans, _shooter, _unitGrp, _unitGrpPR, _pWeapon, _sWeapon, _hWeapon, _magsremoveB, _unitStance, _dis, _Pos, _timer, _pWItems, _sWItems, _hWItems, _pmag, _smag, _hmag, _binocs, _udalenie, _unitLdr, _magsremoveV, _magsremoveB]] call CBA_fnc_waitUntilAndExecute;	
			}, [_unit, _anim, _shans, _shooter, _unitGrp, _unitGrpPR, _pWeapon, _sWeapon, _hWeapon, _magsremoveB, _unitStance, _dis, _Pos, _timer, _pWItems, _sWItems, _hWItems, _pmag, _smag, _hmag, _binocs, _udalenie, _unitLdr, _magsremoveV, _magsremoveB]] call CBA_fnc_waitUntilAndExecute;
		}, [_unit, _anim, _shans, _shooter, _unitGrp, _unitGrpPR, _pWeapon, _sWeapon, _hWeapon, _magsremoveB, _unitStance, _dis, _Pos, _timer, _pWItems, _sWItems, _hWItems, _pmag, _smag, _hmag, _binocs, _udalenie, _unitLdr, _magsremoveV, _magsremoveB], 2] call CBA_fnc_waitAndExecute;	
	}, [_unit, _anim, _shans, _shooter, _unitGrp, _unitGrpPR, _pWeapon, _sWeapon, _hWeapon, _magsremoveB, _unitStance, _dis, _Pos, _timer, _pWItems, _sWItems, _hWItems, _pmag, _smag, _hmag, _binocs, _udalenie, _unitLdr, _magsremoveV, _magsremoveB], 5.033] call CBA_fnc_waitAndExecute; 
}, [_unit, _anim, _shans, _shooter, _unitGrp, _unitGrpPR, _pWeapon, _sWeapon, _hWeapon, _magsremoveB, _unitStance, _dis, _Pos, _timer, _pWItems, _sWItems, _hWItems, _pmag, _smag, _hmag, _binocs, _udalenie, _unitLdr, _magsremoveV, _magsremoveB]] call CBA_fnc_waitUntilAndExecute;
