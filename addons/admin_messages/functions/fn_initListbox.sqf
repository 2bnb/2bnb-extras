...
if !([] call bnb_e_admin_messages_fnc_isAdminOrZeus) exitWith {_ctrl ctrlShow false};
...
if (!isNil "bnb_e_admin_messages_latestConvos" && {count bnb_e_admin_messages_latestConvos > 0}) then {
    ["STR_bnb_e_ADMIN_MESSAGES_LATESTCONVOS"] call _fnc_addHeadline;
    {
        _x call _fnc_addEntry;
        false
    } count bnb_e_admin_messages_latestConvos;
    ["",-1] call _fnc_addEntry;
};


//BY SIDE ======================================================================
["STR_bnb_e_ADMIN_MESSAGES_BYCATEGORY"] call _fnc_addHeadline;
[localize "STR_bnb_e_ADMIN_MESSAGES_EVERYONE",-2] call _fnc_addEntry;
[localize "STR_bnb_e_ADMIN_MESSAGES_OTHERADMINS",-3] call _fnc_addEntry;
...
//LIST OF PLAYERS ==============================================================
["STR_bnb_e_ADMIN_MESSAGES_BYPLAYER"] call _fnc_addHeadline;
private _playerData = [];
{
