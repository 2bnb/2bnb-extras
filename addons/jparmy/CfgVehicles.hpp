...
class CfgVehicles {
    ...
    class B_JapanArmy_Type_22_MRAP_01 : rhsusf_m1240a1_m2_usarmy_wd_OCimport_02 {
        author = "OLt. FarCry";
        scope = 2;
        scopeCurator = 2;
        ...
        faction = "B_JapanArmy";
        crew = "B_JapanArmy_Rifleman_01";
		typicalCargo[] = { "B_JapanArmy_Rifleman_01" };
