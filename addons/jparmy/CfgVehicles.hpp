...
class CfgVehicles {
    ...
    class B_JapanArmy_Type_89_MBT_01 : LeopardTank1_OCimport_02 {
        ...
        class EventHandlers : EventHandlers {
            ...
            class ALiVE_orbatCreator {
                init = "if (local (_this select 0)) then {_onSpawn = {sleep 0.3; _unit = _this select 0;_unit setObjectTextureGlobal [0,'a3\armor_f_epb\mbt_03\data\mbt_03_ext01_co.paa'];_unit setObjectTextureGlobal [1,'a3\armor_f_epb\mbt_03\data\mbt_03_ext02_co.paa'];_unit setObjectTextureGlobal [2,'a3\armor_f_epb\mbt_03\data\mbt_03_rcws_co.paa'];_unit setObjectTextureGlobal [3,'A3\Armor_F\Data\camonet_AAF_Digi_Jungle_CO.paa'];};_this spawn _onSpawn;(_this select 0) addMPEventHandler ['MPRespawn', _onSpawn];};";
            };
